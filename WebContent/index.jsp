      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item">
          <a href="javascript:;">客户信息管理</a>
           <dl class="layui-nav-child">
            <dd><a href="addclient.jsp" target="aaa">添加客户信息</a></dd>
            <dd><a href="client.jsp" target="aaa">客户信息浏览</a></dd>
           </dl>
        </li>
        <li class="layui-nav-item">
          <a href="javascript:;">订单管理</a>
           <dl class="layui-nav-child">
            <dd><a href="addorder.jsp" target="aaa">添加订单</a></dd>
            <dd><a href="order.jsp" target="aaa">订单浏览</a></dd>
           </dl>
        </li>
        <li class="layui-nav-item">
          <a href="javascript:;">用户管理</a>
           <dl class="layui-nav-child">
            <dd><a href="adduser.jsp" target="aaa">添加用户</a></dd>
            <dd><a href="user.jsp" target="aaa">用户权限管理</a></dd>
           </dl>
        </li>
