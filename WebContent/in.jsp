...
<body>  
<h2 style="text-align:center;margin-top:1%">按仓库</h2>
<table class="layui-table" style="width:80%;height:80%;margin-top:5%;margin-left:5%">
  ...
  <tbody>
  	<tr>
  		<%
			try {
				ResultSet rs = stmt.executeQuery("select storehouse,sum(number),sum(number*price) from goodses group by storehouse");
