...
<table class="layui-table" style="width:80%;height:80%;margin-top:5%;margin-left:5%">
  ...
  <tbody>
  	<tr>
  		<%
			try {
				String sql="select top "+pagesize+" * from goodses where id not in(select top "+pagesize*(pagenum-1)+" id from goodses)";
				...
				*/
				while (rs.next()) {
					...
					out.println("<tr><td>" + rs.getInt(1) + "</td><td>" + rs.getString(2) + "</td><td>"
							+ rs.getString(3)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5) + "</td><td><a href='updategoods.jsp?id=" + id
							+ "'>修改</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='delgoods.jsp?id="+id+ "'>删除</a></td></tr>");
				}
